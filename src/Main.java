...
public class Main {
    public static void main(String[] args) {
        ...
        //N.B: when entering string input please insert a whole string with no spaces otherwise the compiler will take
        //the first chunk of the string before the space only
    ...
    // Object 3 -> Educational_info Creation
                ...
                int year = s3.nextInt();
                System.out.println("Education period :"); //takes the period of education and return
